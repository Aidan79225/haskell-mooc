...
_countdown :: Integer -> String
_countdown t 
    | t > 0 = " " ++ show t ++ "..." ++ _countdown (t-1)
    | otherwise = " Liftoff!"
countdown :: Integer -> String
countdown t = "Ready!" ++ _countdown t
...
_smallestDivisor :: Integer -> Integer -> Integer
_smallestDivisor n k = 
    if n `mod` k == 0 then k
    else _smallestDivisor n (k+1)

smallestDivisor :: Integer -> Integer
smallestDivisor n = _smallestDivisor n 2
