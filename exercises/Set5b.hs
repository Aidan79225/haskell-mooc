...
isOrdered' Nothing Nothing (Node v l r) = isOrdered' Nothing (Just v) l && isOrdered' (Just v) Nothing r
isOrdered' (Just mn) Nothing (Node v l r) = v > mn && isOrdered' (Just mn) (Just v) l && isOrdered' (Just v) Nothing r
isOrdered' Nothing (Just mx) (Node v l r) = v < mx && isOrdered' Nothing (Just v) l && isOrdered' (Just v) (Just mx) r
isOrdered' (Just mn) (Just mx) (Node v l r) = v > mn && v < mx && isOrdered' (Just mn) (Just v) l && isOrdered' (Just v) (Just mx) r
------------------------------------------------------------------------------
